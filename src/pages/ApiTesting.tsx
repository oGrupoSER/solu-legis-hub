...
export const processEndpoints: EndpointDef[] = [
  ...
  {
    id: "list-registered-processes", label: "Listar Processos Cadastrados", method: "POST", path: "api-management",
    category: "management", authType: "token",
  ...
  {
    id: "resend-pending-processes", label: "Reenviar Pendentes", method: "POST", path: "api-management",
    category: "management", authType: "token",
  ...
  {
    id: "sync-processes", label: "Sincronizar Processos", method: "POST", path: "api-management",
    category: "management", authType: "token",
  ...
  // ─── REST V3 Andamentos ─────────────────────────────────────
  {
    id: "and-cadastrar-processo", label: "Cadastrar Processo", method: "POST", path: "api-management",
    category: "management", authType: "token",
    ...
    bodyParams: [
      ...
      { key: "data.numProcesso", label: "Número do Processo (CNJ)", placeholder: "0000000-00.0000.0.00.0000", required: true },
      { key: "data.Instancia", label: "Instância", placeholder: "3", required: true, type: "number" },
    ],
  },
  {
    id: "and-excluir-processo", label: "Excluir Processo", method: "POST", path: "api-management",
    category: "management", authType: "token",
    description: "Exclui um processo via API V3 (ExcluirProcesso).",
    params: [],
    bodyParams: [
      { key: "data.service_id", label: "ID do Serviço", placeholder: "uuid do partner_service", required: true },
      { key: "data.codProcesso", label: "Código do Processo", placeholder: "105980409", required: true, type: "number" },
      { key: "data.codEscritorio", label: "Código do Escritório", placeholder: "41", required: true, type: "number" },
    ],
  },
  {
    id: "and-buscar-status", label: "Buscar Status do Processo", method: "POST", path: "api-management",
    category: "management", authType: "token",
    description: "Busca o status de um processo na API V3 (BuscaStatusProcesso).",
    params: [],
    bodyParams: [
      { key: "data.service_id", label: "ID do Serviço", placeholder: "uuid do partner_service", required: true },
      { key: "data.codProcesso", label: "Código do Processo", placeholder: "104795496", required: true, type: "number" },
    ],
  },
  {
    id: "and-buscar-processos", label: "Buscar Processos", method: "POST", path: "api-management",
    category: "management", authType: "token",
  ...
  {
    id: "and-buscar-novos-agrupadores", label: "Buscar Novos Agrupadores", method: "POST", path: "api-management",
    category: "management", authType: "token",
  ...
  {
    id: "and-buscar-agrupadores-escritorio", label: "Buscar Agrupadores Por Escritório", method: "POST", path: "api-management",
    category: "management", authType: "token",
  ...
  {
    id: "and-confirmar-agrupador", label: "Confirmar Recebimento Agrupador", method: "POST", path: "api-management",
    category: "management", authType: "token",
    ...
    bodyParams: [
      { key: "data.service_id", label: "ID do Serviço", placeholder: "uuid do partner_service", required: true },
      { key: "data.codEscritorio", label: "Código do Escritório", placeholder: "41", required: true, type: "number" },
      { key: "data.codAgrupador", label: "Código do Agrupador", placeholder: "64010523", required: true, type: "number" },
    ],
  },
  {
    id: "and-buscar-novas-dependencias", label: "Buscar Novas Dependências", method: "POST", path: "api-management",
    category: "management", authType: "token",
  ...
  {
    id: "and-buscar-dependencias-escritorio", label: "Buscar Dependências Por Escritório", method: "POST", path: "api-management",
    category: "management", authType: "token",
  ...
  {
    id: "and-confirmar-dependencia", label: "Confirmar Recebimento Dependências", method: "POST", path: "api-management",
    category: "management", authType: "token",
    ...
    bodyParams: [
      { key: "data.service_id", label: "ID do Serviço", placeholder: "uuid do partner_service", required: true },
      { key: "data.codEscritorio", label: "Código do Escritório", placeholder: "41", required: true, type: "number" },
      { key: "data.codDependencia", label: "Código da Dependência", placeholder: "24870613", required: true, type: "number" },
    ],
  },
  {
    id: "and-buscar-novos-andamentos", label: "Buscar Novos Andamentos", method: "POST", path: "api-management",
    category: "management", authType: "token",
  ...
  {
    id: "and-buscar-andamentos-escritorio", label: "Buscar Andamentos Por Escritório", method: "POST", path: "api-management",
    category: "management", authType: "token",
  ...
  {
    id: "and-confirmar-andamento", label: "Confirmar Recebimento de Andamentos", method: "POST", path: "api-management",
    category: "management", authType: "token",
    ...
    bodyParams: [
      { key: "data.service_id", label: "ID do Serviço", placeholder: "uuid do partner_service", required: true },
      { key: "data.codEscritorio", label: "Código do Escritório", placeholder: "41", required: true, type: "number" },
      { key: "data.codAndamento", label: "Código do Andamento", placeholder: "123", required: true, type: "number" },
      { key: "data.codProcesso", label: "Código do Processo", placeholder: "123", required: true, type: "number" },
      { key: "data.codAgrupador", label: "Código do Agrupador", placeholder: "123", required: true, type: "number" },
    ],
  },
  {
    id: "and-buscar-capa", label: "Busca Capa por Processo", method: "POST", path: "api-management",
    category: "management", authType: "token",
  ...
  {
    id: "and-buscar-novos-documentos", label: "Buscar Novos Documentos", method: "POST", path: "api-management",
    category: "management", authType: "token",
  ...
  {
    id: "and-buscar-documentos-escritorio", label: "Buscar Documentos Escritório", method: "POST", path: "api-management",
    category: "management", authType: "token",
  ...
  {
    id: "and-confirmar-documento", label: "Confirmar Recebimento Documento", method: "POST", path: "api-management",
    category: "management", authType: "token",
    ...
    bodyParams: [
      { key: "data.service_id", label: "ID do Serviço", placeholder: "uuid do partner_service", required: true },
      { key: "data.codEscritorio", label: "Código do Escritório", placeholder: "41", required: true, type: "number" },
      { key: "data.codDocumento", label: "Código do Documento", placeholder: "2", required: true, type: "number" },
    ],
  },
  {
    id: "and-todos-andamentos-processo", label: "Todos Andamentos por Processo", method: "POST", path: "api-management",
    category: "management", authType: "token",
  ...
  {
    id: "and-todos-agrupadores-processo", label: "Todos Agrupadores por Processo", method: "POST", path: "api-management",
    category: "management", authType: "token",
  ...
  {
    id: "and-todos-documentos-processo", label: "Todos Documentos por Processo", method: "POST", path: "api-management",
    category: "management", authType: "token",
  ...
  {
    id: "and-processos-cadastrados", label: "Processos Cadastrados", method: "POST", path: "api-management",
    category: "management", authType: "token",
  ...
  {
    id: "and-qtd-andamentos", label: "QTD Andamentos Disponíveis", method: "POST", path: "api-management",
    category: "management", authType: "token",
